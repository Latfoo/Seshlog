...
SESSIONS = [
    (0,  9, 25, ["coding"]),
    (0, 10, 25, ["coding"]),
    (0, 14, 20, ["deep-work", "planning"]),
    (1,  9, 25, ["studying"]),
    (1, 10, 25, ["studying"]),
    (1, 11, 25, ["studying"]),
    (1, 15, 25, ["planning"]),
    (2, 10, 15, ["deep-work", "coding", "planning"]),
    (2, 14, 25, ["coding"]),
    (3,  9, 25, ["reading"]),
    (3, 10, 25, ["reading"]),
    (5,  9, 25, ["coding"]),
    ...
    (5, 14, 25, ["coding"]),
    (6,  9, 25, ["planning"]),
    (7, 10, 25, ["deep-work", "studying"]),
    (7, 13, 25, ["coding"]),
    (8,  9, 25, ["studying"]),
    (8, 10, 25, ["studying"]),
    (8, 11, 25, ["studying"]),
    (9, 14, 20, ["deep-work", "coding", "reading"]),
    (9, 16, 25, ["coding"]),
    (10, 9, 25, ["reading"]),
    (12, 9, 25, ["coding"]),
    (12, 10, 25, ["coding"]),
    (13, 14, 25, ["planning"]),
    (14, 10, 15, ["deep-work", "planning"]),
    (15, 9, 25, ["coding"]),
    (15, 14, 25, ["studying"]),
    (16, 9, 25, ["coding"]),
    (16, 10, 25, ["coding"]),
    (19, 9, 25, ["reading"]),
    (19, 10, 25, ["studying"]),
    (20, 14, 20, ["deep-work", "coding", "studying"]),
    (21, 9, 25, ["planning"]),
    (22, 10, 25, ["coding"]),
    (22, 11, 25, ["coding"]),
]
